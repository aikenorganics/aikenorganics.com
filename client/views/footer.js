    ...
    <div className='container'>
      <div className='row'>
        ...
        <div className='col-md-4'>
          <h2>Social</h2>
          <p>
            <a href='https://twitter.com/aikenorganics' className='align-middle'>
              <svg viewBox='0 0 16 16' xmlns='http://www.w3.org/2000/svg' fill='currentColor' fillRule='evenodd' clipRule='evenodd' strokeLinejoin='round' strokeMiterlimit='1.414' width='32' height='32'>
            ...
            {' '}
            <a href='https://www.facebook.com/aikenorganics' className='align-middle'>
              <svg viewBox='0 0 16 16' xmlns='http://www.w3.org/2000/svg' fill='currentColor' fillRule='evenodd' clipRule='evenodd' strokeLinejoin='round' strokeMiterlimit='1.414' width='32' height='32'>
            ...
            {' '}
            <a href='https://instagram.com/aikenorganics' className='align-middle'>
              <svg viewBox='0 0 16 16' xmlns='http://www.w3.org/2000/svg' fill='currentColor' fillRule='evenodd' clipRule='evenodd' strokeLinejoin='round' strokeMiterlimit='1.414' width='32' height='32'>
